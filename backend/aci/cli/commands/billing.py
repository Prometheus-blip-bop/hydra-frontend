...
PLANS_DATA = [
    ...
    Plan(
        name="starter",
        stripe_product_id="prod_STARTER_placeholder",
    ...
    Plan(
        name="team",
        stripe_product_id="prod_TEAM_placeholder",
        stripe_monthly_price_id="price_TEAM_monthly_placeholder",
        stripe_yearly_price_id="price_TEAM_yearly_placeholder",
        features=PlanFeatures(
            linked_accounts=10000,
            api_calls_monthly=10000000,
            agent_credentials=10000,
